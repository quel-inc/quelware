...
from quel_ic_config.exstickge_coap_client import (
    ...
    Quel1seBoard,
    SyncAsyncCoapClientWithDeviceLock,
...
class ExstickgeCoapClientQuel1seRiken8WithLock(ExstickgeCoapClientQuel1seRiken8):
    _VERSION_SPEC: Tuple[Version, Version, Set[Version]] = Version("1.3.0"), Version("1.3.0"), set()

    def _creating_core(self) -> AbstractSyncAsyncCoapClient:
        return SyncAsyncCoapClientWithDeviceLock(self._target)
