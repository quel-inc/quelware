...
class _ExstickgeCoapClientQuel1seFujitsu11Base(_ExstickgeCoapClientQuel1seTempctrlBase):
    _VALID_BOXTYPE: Set[str] = {"quel1se-fujitsu11"}
    ...
    _AVAILABLE_BOARDS: Set[Quel1seBoard] = {Quel1seBoard.POWER, Quel1seBoard.MIXER0, Quel1seBoard.MIXER1}
...
class _Quel1seFujitsu11ConfigSubsystemBase(
    Quel1ConfigSubsystemRoot,
    Quel1ConfigSubsystemAd9082Mixin,
    Quel1ConfigSubsystemLmx2594Mixin,
    Quel1ConfigSubsystemAd6780Mixin,
    ...
    def _create_exstickge_proxy(
        ...
        if is_coap_firmware:
            for proxy_cls in (ExstickgeCoapClientQuel1seFujitsu11,):
...
class Quel1seFujitsu11ConfigSubsystem(
    _Quel1seFujitsu11ConfigSubsystemBase,
    Quel1seConfigSubsystemTempctrlMixin,
):
    ...
    def configure_peripherals(
        ...
        _Quel1seFujitsu11ConfigSubsystemBase.configure_peripherals(
            self, ignore_access_failure_of_adrf6780, ignore_lock_failure_of_lmx2594
        )
        self.init_tempctrl()


class Quel1seFujitsu11DebugConfigSubsystem(
    _Quel1seFujitsu11ConfigSubsystemBase,
    Quel1seConfigSubsystemTempctrlDebugMixin,
):
