...
from typing import Any, Collection, Dict, Final, List, Mapping, Optional, Sequence, Set, Tuple, Union
...
class Quel1ConfigSubsystemRoot(Quel1ConfigSubsystemBaseSlot):
    ...
    def __init__(
        ...
        self._features: Set[Quel1Feature] = set()
        ...
        self._param: Dict[str, Any] = {}  # TODO: Dict[str, Any] is tentative.
    ...
    def initialize(self, features: Optional[Collection[Quel1Feature]] = None) -> None:
        self._features = set(features) if features is not None else {Quel1Feature.SINGLE_ADC}
        self._param = self._load_config()
