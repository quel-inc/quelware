...
typedef struct {
    ...
    uint8_t             lane_mapping[2][8];   /*Deserialise Lane Mapping, Map Virtual Converter to Physical Lane, index is logical lane, value is physical lane*/
