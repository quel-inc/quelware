...
#define AD9082_DAC_CLK_FREQ_HZ_MIN    2900000000ULL
#define AD9082_DAC_CLK_FREQ_HZ_MAX    12000000000ULL
#define AD9082_ADC_CLK_FREQ_HZ_MIN    1450000000ULL
#define AD9082_ADC_CLK_FREQ_HZ_MAX    6000000000ULL
#define AD9082_REF_CLK_FREQ_HZ_MIN    24000000ULL
#define AD9082_REF_CLK_FREQ_HZ_MAX    3000000000ULL
#define AD9082_JESDRX_204C_CAL_THRESH 16000000000ULL
#define AD9082_JESD_SER_COUNT         8
#define AD9082_JESD_DESER_COUNT       8

#define AD9082_USE_FLOATING_TYPE      0
#define AD9082_USE_SPI_BURST_MODE     0
 ...
 */
typedef enum {
    AD9082_DAC_DP_NONE = 0x0,                            /*!< No Coarse DUC /No Main DAC Datapath */
    AD9082_DAC_DP_0 = 0x1,                               /*!< Coarse DUC 0/ Main DAC0 Datapath */
    AD9082_DAC_DP_1 = 0x2,                               /*!< Coarse DUC 1/ Main DAC1 Datapath */
    AD9082_DAC_DP_2 = 0x4,                               /*!< Coarse DUC 2/ Main DAC2 Datapath */
    AD9082_DAC_DP_3 = 0x8,                               /*!< Coarse DUC 3/ Main DAC3 Datapath */
    AD9082_DAC_DP_ALL = 0x0F                             /*!< ALL Coarse DUC /ALL Main DAC Datapths */
}adi_ad9082_dac_dp_select_e;

/*!
 * @brief Enumerates DAC PAIRING for DAC mode Configuration
 */
typedef enum {
    AD9082_DAC_PAIR_NONE = 0x00,         /*!< No Group */
    AD9082_DAC_PAIR_0_1 = 0x01,          /*!< Group 0 (DAC0 & DAC1) */
    AD9082_DAC_PAIR_2_3 = 0x02,          /*!< Group 1 (DAC2 & DAC3) */
    AD9082_DAC_PAIR_ALL = 0x03,          /*!< All Groups */
}adi_ad9082_dac_pair_select_e;
 ...
 */
typedef enum {
    AD9082_DAC_MUX_MODE_0 = 0x00,                         /*!<  I0.Q0 -> DAC0, Complex I1.Q1 -> DAC1 */
    AD9082_DAC_MUX_MODE_1 = 0x01,                         /*!< (I0 + I1) / 2 -> DAC0, (Q0 + Q1) / 2 -> DAC1, Data Path NCOs Bypassed */
    AD9082_DAC_MUX_MODE_2 = 0x02,                         /*!< I0 -> DAC0, Q0 -> DAC1, Datapath0 NCO Bypassed, Datapath1 Unused */
    AD9082_DAC_MUX_MODE_3 = 0x03,                         /*!< (I0 + I1) / 2 -> DAC0, DAC1 Output Tied To Midscale */
}adi_ad9082_dac_mod_mux_mode_e;
...
typedef enum {
   ...
   AD9082_ADC_PFIR_I_MODE_REAL_N4 = 0x1,              /*!< Real N/4 tap filter */
   AD9082_ADC_PFIR_I_MODE_REAL_N2 = 0x2,              /*!< Real N/2 tap filter */
   AD9082_ADC_PFIR_I_MODE_MATRIX = 0x4,               /*!< N/4 tap matrix mode */
   AD9082_ADC_PFIR_I_MODE_COMPLEX_FULL = 0x5,         /*!< N/3 tap full complex */
   AD9082_ADC_PFIR_I_MODE_COMPLEX_HALF = 0x6,         /*!< Half complex using 2 N/2 tap filters */
   AD9082_ADC_PFIR_I_MODE_REAL_N = 0x7                /*!< Real N tap filter */
...
typedef enum {
   ...
   AD9082_ADC_PFIR_Q_MODE_REAL_N4 = 0x1,              /*!< Real N/4 tap filter */
   AD9082_ADC_PFIR_Q_MODE_REAL_N2 = 0x2,              /*!< Real N/2 tap filter */
   AD9082_ADC_PFIR_Q_MODE_MATRIX = 0x4,               /*!< N/4 tap matrix mode */
   AD9082_ADC_PFIR_Q_MODE_COMPLEX_FULL = 0x5,         /*!< N/3 tap full complex */
   AD9082_ADC_PFIR_Q_MODE_COMPLEX_HALF = 0x6,         /*!< Half complex using 2 N/2 tap filters */
   AD9082_ADC_PFIR_Q_MODE_REAL_N = 0x7                /*!< Real N tap filter */
...
*/
typedef enum {
    AD9082_ADC_PFIR_REAL_I_LOAD = 0x1,                /*!< Set the coefficients streamed type to real I */
    AD9082_ADC_PFIR_REAL_Q_LOAD = 0x2,                /*!< Set the coefficients streamed type to real Q */
    AD9082_ADC_PFIR_REAL_CROSS_I_LOAD = 0x4,          /*!< Set the coefficients streamed type to real cross I */
    AD9082_ADC_PFIR_REAL_CROSS_Q_LOAD = 0x8,          /*!< Set the coefficients streamed type to real cross Q */
    AD9082_ADC_PFIR_COMPLEX_LOAD = 0x10,              /*!< Set the coefficients streamed type to complex mode */
    AD9082_ADC_PFIR_COEFF_CLEAR = 0x20                /*!< Clear currently selected main coefficient bank */
} adi_ad9082_adc_pfir_coeff_load_sel_e;

/*!
 *@brief Enumerates ADC Bypass mode
 */
typedef enum {
    AD9082_ADC_MAIN_DP_MODE = 0x0,                    /*!< Main receive datapath */
    AD9082_ADC_FBW_MODE = 0x1,                        /*!< Full bandwidth mode bypass datapath */
    AD9082_ADC_TEST_MODE = 0x2                        /*!< Test mode bypass datapath */
} adi_ad9082_adc_bypass_mode_e;
 ...
 */
typedef enum {
    AD9082_JESD_RX_PRBS_TEST_DATA_SRC_LANE = 0x0,     /*!< Lane Data As Test Data Source */
    AD9082_JESD_RX_PRBS_TEST_DATA_SRC_SAMPLE = 0x1    /*!< Sample Data As Test Data Source (M0 Only) */
}adi_ad9082_jesd_rx_prbs_test_data_src_e;

/*!
 * @brief Enumerates JESD Rx PRBS Test Mode
 */
typedef enum {
    AD9082_JESD_RX_PRBS_TEST_MODE_OFF = 0x0,          /*!< Disable PRBS Test Mode */
    AD9082_JESD_RX_PRBS_TEST_MODE_PRBS7 = 0x1,        /*!< PRBS7 */
    AD9082_JESD_RX_PRBS_TEST_MODE_PRBS9 = 0x2,        /*!< PRBS9 */
    AD9082_JESD_RX_PRBS_TEST_MODE_PRBS15 = 0x3,       /*!< PRBS15 */
    AD9082_JESD_RX_PRBS_TEST_MODE_PRBS31 = 0x4        /*!< PRBS31 */
}adi_ad9082_jesd_rx_prbs_test_mode_e;

/*!
 * @brief Enumerates JESD Tx Test Data Source (Inject Point)
 */
typedef enum {
    AD9082_JESD_TX_TEST_DATA_SAMPLE = 0x0,            /*!< Sample Data As Test Data Source */
    AD9082_JESD_TX_TEST_DATA_PHY = 0x1,               /*!< PHY Data As Test Data Source */
    AD9082_JESD_TX_TEST_DATA_SCRAMBLER_INPUT = 0x2    /*!< Scrambler Input Data As Data Source */
}adi_ad9082_jesd_tx_test_data_src_e;

/*!
 * @brief Enumerates JESD Tx Test Mode
 */
typedef enum {
    AD9082_JESD_TX_TEST_MODE_DISABLED = 0x0,          /*!< Disable Test Mode */
    AD9082_JESD_TX_TEST_MODE_CHECKER_BOARD = 0x1,     /*!< Checker Board Test Mode */
    AD9082_JESD_TX_TEST_MODE_WORD_TOGGLE = 0x2,       /*!< Word Toggle Test Mode */
    AD9082_JESD_TX_TEST_MODE_PN31 = 0x3,              /*!< PN31 Test Mode */
    AD9082_JESD_TX_TEST_MODE_PN15 = 0x5,              /*!< PN15 Test Mode */
    AD9082_JESD_TX_TEST_MODE_PN7 = 0x7,               /*!< PN7  Test Mode */
    AD9082_JESD_TX_TEST_MODE_RAMP = 0x8,              /*!< Ramp Test Mode */
    AD9082_JESD_TX_TEST_MODE_USER_REPEAT = 0xE,       /*!< Repeated User Data Test Mode */
    AD9082_JESD_TX_TEST_MODE_USER_SINGLE = 0xF        /*!< Single Time User Data Test Mode */
}adi_ad9082_jesd_tx_test_mode_e;
...
typedef enum {
    ...
    AD9082_TMODE_POS_FULL    = 0x2,                   /*!< Positive Full-Scale, 0x7FFF */
    AD9082_TMODE_NEG_FULL    = 0x3,                   /*!< Negative Full-Scale, 0x8000 */
    AD9082_TMODE_ALT_CHECKER = 0x4,                   /*!< Alternating Checker Board, 0x5555-0xAAAA */
    AD9082_TMODE_PN23        = 0x5,                   /*!< PN23 Sequence */
    AD9082_TMODE_PN9         = 0x6,                   /*!< PN9  Sequence */
    AD9082_TMODE_1_0_TOGG    = 0x7,                   /*!< 1/0 Word Toggle, 0x0000-0xFFFF */
 ...
 */
typedef enum {
    AD9082_FULL_RATE = 0,                             /*!< Full rate operation */
    AD9082_HALF_RATE = 1,                             /*!< Half rate operation */
    AD9082_QUART_RATE = 2                             /*!< Quarter rate operation */
}adi_ad9082_deser_mode_e;
 ...
 */
typedef enum {
    AD9082_SER_SWING_1000 = 0,                        /*!< 1000 mV Swing */
    AD9082_SER_SWING_850 = 1,                         /*!< 850 mV Swing */
    AD9082_SER_SWING_750 = 2,                         /*!< 750 mV Swing */
    AD9082_SER_SWING_500 = 3                          /*!< 500 mV Swing */
}adi_ad9082_ser_swing_e;

/*!
 * @brief Enumerates JESD Serializer Pre-Emphasis Settings
 */
typedef enum {
    AD9082_SER_PRE_EMP_0DB = 0,                       /*!< 0 db Pre-Emphasis */
    AD9082_SER_PRE_EMP_3DB = 1,                       /*!< 3 db Pre-Emphasis */
    AD9082_SER_PRE_EMP_6DB = 2                        /*!< 6 db Pre-Emphasis */
}adi_ad9082_ser_pre_emp_e;

/*!
 * @brief Enumerates JESD Serializer Post-Emphasis Settings
 */
typedef enum {
    AD9082_SER_POST_EMP_0DB = 0,                      /*!< 0 db Post-Emphasis */
    AD9082_SER_POST_EMP_3DB = 1,                      /*!< 3 db Post-Emphasis */
    AD9082_SER_POST_EMP_6DB = 2,                      /*!< 6 db Post-Emphasis */
    AD9082_SER_POST_EMP_9DB = 3,                      /*!< 9 db Post-Emphasis */
    AD9082_SER_POST_EMP_12DB = 4                      /*!< 12 db Post-Emphasis */
}adi_ad9082_ser_post_emp_e;
/*!
 * @brief Enumerates JESD Deserializer Quarter rate Calibration Run Modes
 */
typedef enum {
    AD9082_CAL_MODE_RUN = 0,                          /*!< Run 204C QR Calibration*/
    AD9082_CAL_MODE_RUN_AND_SAVE = 1,                 /*!< Run 204C QR Calibration and save CTLE Coefficients*/
    AD9082_CAL_MODE_BYPASS = 2                        /*!< Bypass 204C QR Calibration and load CTLE Coefficients*/
}adi_ad9082_cal_mode_e;

/*!
 * @brief Programmable gain scaling on PFIR Structure
 */
typedef struct {
    adi_ad9082_adc_pfir_gain_e ix_gain;               /*!< Programmable scalar gain at the output of A(z) FIR filter  */
    adi_ad9082_adc_pfir_gain_e iy_gain;               /*!< Programmable scalar gain at the output of B(z) FIR filter  */
    adi_ad9082_adc_pfir_gain_e qx_gain;               /*!< Programmable scalar gain at the output of C(z) FIR filter  */
    adi_ad9082_adc_pfir_gain_e qy_gain;               /*!< Programmable scalar gain at the output of D(z) FIR filter  */
}adi_ad9082_adc_pfir_gain_t;

/*!
 * @brief Per lane JESD Serializer Settings
 */
typedef struct {
    adi_ad9082_ser_swing_e    swing_setting;
    adi_ad9082_ser_pre_emp_e  pre_emp_setting;
    adi_ad9082_ser_post_emp_e post_emp_setting;
}adi_ad9082_ser_lane_settings_t;

/*!
 * @brief Full JESD Serializer Settings Structure
 */
typedef struct {
    adi_ad9082_ser_lane_settings_t lane_settings[8];
    uint8_t                      invert_mask;
...
typedef struct {
    ...
    adi_ad9082_cal_mode_e cal_mode;             /*Flag to configure calibration run */
...
}adi_ad9082_des_settings_t;

/*!
 * @brief Full JESD SERDES Settings Structure
 */
typedef struct {
    adi_ad9082_ser_settings_t ser_settings;           /*! Jesd Tx Serializer Settings */
    adi_ad9082_des_settings_t des_settings;           /*! Jesd Rx Deserializer Settings */
}adi_ad9082_serdes_settings_t;
...
typedef struct {
    ...
    adi_ad9082_serdes_settings_t serdes_info;
    adi_ad9082_clk_t clk_info;
}adi_ad9082_device_t;
 ...
 *         adi_ad9082_device_reset() will be called if operation is AD9082_SOFT_RESET_AND_INIT or
 *         AD9082_HARD_RESET_AND_INIT.
 *
 * @param  device    Pointer to the device structure
...
/**
 * @ingroup dev_init
 * @brief  System Top Level API. \n Initialize ad9082 device
 *         This API will configure device SPI working mode, and check power supplies status. Must be called
 *         after platform SPI master is already initialized and adi_ad9082_device_reset() is called.
 *
 * @param  device Pointer to the device structure
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 ...
 *         This API should be called after adi_ad9082_device_init().
 *
 * @param  device     Pointer to the device structure
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_clk_config_set(adi_ad9082_device_t *device, uint64_t dac_clk_hz, uint64_t adc_clk_hz, uint64_t ref_clk_hz);
 ...
 *         adi_ad9082_device_clk_config_set().
 *
 * @param  device   Pointer to the device structure
 ...
 *         This API will be called after adi_ad9082_device_clk_config_set().
 *
 * @param  device    Pointer to the device structure.
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_laminate_id_get(adi_ad9082_device_t *device, uint8_t *id);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_die_id_get(adi_ad9082_device_t *device, uint8_t *id);
 ...
 *         This API will be called by adi_ad9082_device_init().
 *
 * @param  device Pointer to the device structure
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 ...
 *         This API will be called by adi_ad9082_device_clk_config_set().
 *
 * @param  device     Pointer to the device structure
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_main_auto_clk_gen_enable(adi_ad9082_device_t *device, uint8_t enable);
 ...
 *         This API will be called after adi_ad9082_device_clk_config_set().
 * @deprecated call adi_ad9082_device_startup_nco_test_mode 
 *
 * @param  device         Pointer to the device structure
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_startup_nco_test(adi_ad9082_device_t *device, uint8_t main_interp, uint8_t chan_interp,
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_startup_nco_test_mode(adi_ad9082_device_t *device, uint8_t main_interp, uint8_t chan_interp,
 ...
 * @ingroup tx_data_path_setup
 * @brief  System Top Level API. \n Set Fine DUC gain
 *         Call after adi_ad9082_device_startup_tx().
 *
 * @param  device   Pointer to the device structure
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_nco_gains_set(adi_ad9082_device_t *device, uint16_t gains[8]);
 ...
 *
 * @param  device   Pointer to the device structure
 * @param  dac_pair DAC Pair Select for mode configuration @see adi_ad9082_dac_pair_select_e
 * @param  mode     Working mode, @see adi_ad9082_dac_mode_e
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_modulation_mux_mode_set(adi_ad9082_device_t *device, adi_ad9082_dac_pair_select_e dac_pair, adi_ad9082_dac_mod_mux_mode_e mode);
 ...
 *
 * @param  device   Pointer to the device structure
 * @param  groups   Mode switch groups, @see adi_ad9082_dac_pair_select_e
 * @param  enable   1 to enable complex modulation
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_complex_modulation_enable_set(adi_ad9082_device_t *device, adi_ad9082_dac_pair_select_e dac_pair, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_tx_enable_state_machine_enable_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_spi_as_tx_en_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_gpio_as_tx_en_set(adi_ad9082_device_t *device, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_fsc_set(adi_ad9082_device_t *device, uint8_t dacs, uint32_t uA, uint8_t rerun_cal);
 ...
 *         adi_ad9082_device_startup_tx(), Sets the DAC to Channel xbar based on channel interpolation
 ...
 *         adi_ad9082_device_startup_tx or adi_ad9082_dac_interpolation_set
 *
 * @param  device     Pointer to the device structure
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_data_xor_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t channels, int64_t shift_hz, uint16_t offset, uint8_t test_tone_en);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_nco_enable_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t channels, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_nco_reset_set(adi_ad9082_device_t *device, uint8_t chan_nco_reset, uint8_t main_nco_reset);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_nco_phase_offset_set(adi_ad9082_device_t *device, uint8_t dacs, uint16_t dac_phase_offset, uint8_t channels, uint16_t ch_phase_offset);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_main_nco_ftw_get(adi_ad9082_device_t *device, uint8_t dacs, uint64_t *ftw, uint64_t *acc_modulus, uint64_t *acc_delta);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_channel_nco_ftw_get(adi_ad9082_device_t *device, uint8_t channels, uint64_t *ftw, uint64_t *acc_modulus, uint64_t *acc_delta);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_sel_sideband_enable_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t channels, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_main_nco_hopf_gpio_no_glitch_en_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_main_nco_hopf_gpio_as_hop_en_set(adi_ad9082_device_t *device, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_soft_off_gain_enable_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_soft_off_new_gain_enable_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_soft_off_gain_ramp_rate_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t rate);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_soft_off_enable_set(adi_ad9082_device_t *device, uint8_t dacs, uint16_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_soft_on_enable_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_long_pa_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t enable,
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_long_pa_power_get(adi_ad9082_device_t *device, uint8_t dacs, uint16_t *power);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_short_pa_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t enable,
    uint8_t averaging_time, uint16_t average_threshold);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_short_pa_power_get(adi_ad9082_device_t *device, uint8_t dacs, uint16_t *power);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_rotation_mode_set(adi_ad9082_device_t *device, uint8_t mode);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_gpio_as_pa_en_set(adi_ad9082_device_t *device, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_main_dsa_enable_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_main_dig_gain_set(adi_ad9082_device_t *device, uint8_t dacs, uint16_t gain);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_main_dsa_set(adi_ad9082_device_t *device, uint8_t dacs, uint8_t code, uint8_t cutover, uint8_t boost,  uint16_t gain);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details. 
 */
int32_t adi_ad9082_dac_dll_power_down(adi_ad9082_device_t *device, uint8_t dacs);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_calc_nco_ftw(adi_ad9082_device_t* device, uint64_t freq, int64_t nco_shift, uint64_t *ftw, uint64_t *a, uint64_t *b);
 ...
 *         This API will be called by adi_ad9082_device_startup_nco_test().
 *
 * @param  device   Pointer to the device structure
 * @param  channels Channel mask
 * @param  enable   1:enable, 0:disable
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_duc_chan_skew_set(adi_ad9082_device_t *device, uint8_t channels, uint8_t skew);
 ...
 * @param  jesd_conv_sel  JTX virutal converter selection, @see adi_ad9082_adc_fine_ddc_converter_e
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_startup_rx(adi_ad9082_device_t *device, uint8_t cddcs, uint8_t fddcs,
    ...
    adi_ad9082_jtx_conv_sel_t jesd_conv_sel[2]);


/**
 * @ingroup rx_setup
 * @brief  System Top Level API. \n Configure NCO mode for the coarse DDCs
 *         Call after adi_ad9082_device_startup_rx().
 *
 * @param  device     Pointer to the device structure
 * @param  cddcs      Coarse DDCs selection, @see adi_ad9082_adc_coarse_ddc_select_e
 * @param  nco_mode   NCO mode selection, @see adi_ad9082_adc_nco_mode_e
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
 ...
 *
 * @param  device           Pointer to the device structure
 * @param  adc_cddc_xbar    ADC to Coarse DDC Crossbar, @see adi_ad9082_adc_adc_to_cddc_xbar_e
 * @param  cddc_fddc_xbar   Coarse to Fine DDC Crossbar, @see adi_ad9082_adc_cddc_to_fddc0_xbar_e, ...
 ...
 * @param  device          Pointer to the device structure
 * @param  links           Target link select
 * @param  jesd_m          jesd_m[0] - Number of used virtual converters for AD9082_LINK_0.
 *                         jesd_m[1] - Number of used virtual converters for AD9082_LINK_1.
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  adc_sel        Masked list of ADC, as defined by adi_ad9082_adc_sel_e to be assign nyquist zone as described by zone parameter
 * @param  zone           Desired nyquist zone operation for the adcs specified by adc_sel parameter. 
 *                        AD9082_ADC_NYQUIST_ZONE_ODD  
 *                        AD9082_ADC_NYQUIST_ZONE_EVEN
 *
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 ...
 *
 * @param  device   Pointer to the device structure
 * @param  fddcs    Fine DDCs selection, @see adi_ad9082_adc_fine_ddc_select_e
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  adc_sel        Masked list of ADC, as defined by adi_ad9082_adc_sel_e to be enabled/disabled data inversion as described by enable parameter
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  adc_sel        Masked list of ADC, as defined by adi_ad9082_adc_sel_e to be enabled/disabled timing calibration as described by enable parameter
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  adc_sel        Masked list of ADC, as defined by adi_ad9082_adc_sel_e to be enabled/disabled offset calibration as described by enable parameter
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  adc_sel        Masked list of ADC, as defined by adi_ad9082_adc_sel_e to be enabled/disabled gain calibration as described by enable parameter
 ...
 *         Call after adi_ad9082_device_startup_rx_bypass_mode().
 *
 * @param  device       Pointer to the device structure
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 ...
 *
 * @param  device            Pointer to the device structure
 * @param  adcs              ADC selection, @see adi_ad9082_adc_select_e
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  src_adc        Source ADC selection (FD0) @see adi_ad9082_adc_select_e
 * @param  dst_adc        Output ADC selection (FD0) @see adi_ad9082_adc_select_e
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  src_adc        Source ADC selection (FD1) @see adi_ad9082_adc_select_e
 * @param  dst_adc        Output ADC selection (FD1) @see adi_ad9082_adc_select_e
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
 ...
 *                        @see adi_ad9082_adc_fd_thresh_set
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_adc_pfir_i_mode_set(adi_ad9082_device_t *device, adi_ad9082_adc_pfir_ctl_page_e ctl_pages, adi_ad9082_adc_pfir_i_mode_e i_mode);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_adc_pfir_q_mode_set(adi_ad9082_device_t *device, adi_ad9082_adc_pfir_ctl_page_e ctl_pages, adi_ad9082_adc_pfir_q_mode_e q_mode);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_adc_pfir_i_gain_set(adi_ad9082_device_t *device, adi_ad9082_adc_pfir_ctl_page_e ctl_pages, adi_ad9082_adc_pfir_gain_e ix_gain, adi_ad9082_adc_pfir_gain_e iy_gain);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_adc_pfir_q_gain_set(adi_ad9082_device_t *device, adi_ad9082_adc_pfir_ctl_page_e ctl_pages, adi_ad9082_adc_pfir_gain_e qx_gain, adi_ad9082_adc_pfir_gain_e qy_gain);
 ...
 *                            ctrl_pages == AD9082_ADC_PFIR_ADC_PAIR0: 0 - ADC0, 1 - ADC2, 2 - ADC1, 3 - ADC3
 *                            ctrl_pages == AD9082_ADC_PFIR_ADC_PAIR1: 0 - ADC1, 1 - ADC3, 2 - ADC0, 3 - ADC2
 * @param  q_sel          Q-path data input
 *                            ctrl_pages == AD9082_ADC_PFIR_ADC_PAIR0: 0 - ADC2, 1 - ADC1, 2 - ADC3, 3 - ADC0
 *                            ctrl_pages == AD9082_ADC_PFIR_ADC_PAIR1: 0 - ADC3, 1 - ADC0, 2 - ADC2, 3 - ADC1
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_adc_pfir_din_select_set(adi_ad9082_device_t *device, adi_ad9082_adc_pfir_ctl_page_e ctl_pages, uint8_t i_sel, uint8_t q_sel);
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  adcs           ADC to set, @see adi_ad9082_adc_select_e
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  coeff_pages    PFIR coefficient pages @see adi_ad9082_adc_pfir_ctl_page_e
 ...
 * @param  i_mode         PFIR i-mode @see adi_ad9082_adc_pfir_i_mode_e
 * @param  q_mode         PFIR q-mode @see adi_ad9082_adc_pfir_q_mode_e
 * @param  gain           PFIR gain structure for each filter @see adi_ad9082_adc_pfir_gain_e
...
int32_t adi_ad9082_adc_pfir_coeff_table_load_set(adi_ad9082_device_t *device, adi_ad9082_adc_pfir_ctl_page_e ctl_pages, adi_ad9082_adc_pfir_coeff_page_e coeff_pages,
    adi_ad9082_adc_pfir_i_mode_e i_mode,  adi_ad9082_adc_pfir_q_mode_e q_mode,
    adi_ad9082_adc_pfir_gain_t *gain, int16_t* coeffs, uint8_t clear_coeffs);
 ...
 *
 * @param  device     Pointer to the device structure
 * @param  cddc       Coarse DDCs selection, @see adi_ad9082_adc_coarse_ddc_select_e
 ...
 *
 * @param  device     Pointer to the device structure
 * @param  fddc       Fine DDCs selection, @see adi_ad9082_adc_fine_ddc_select_e
 * @param  ftw        Pointer of frequency tuning word
 * @param  modulus_a  Pointer of modulus A word
 * @param  modulus_b  Pointer of modulus B word
 *
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_nco_sync_pre(adi_ad9082_device_t *device);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_nco_sync_post(adi_ad9082_device_t *device);
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  fddcs          @see adi_ad9082_adc_fine_ddc_select_e
 * @param  i_status_adc   @see adi_ad9082_adc_select_e
 * @param  q_status_adc   @see adi_ad9082_adc_select_e
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  i_status_sel   Fractional delay i status select, @see adi_ad9082_adc_select_e
 * @param  q_status_sel   Fractional delay q status select, @see adi_ad9082_adc_select_e
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
 ...
 *
 * @param  device   Pointer to the device structure
 * @param  links    JESD links selection, @see adi_ad9082_jesd_link_select_e
 ...
 *
 * @param  device           Pointer to the device structure
 * @param  fddc             Fine DDC, @see adi_ad9082_adc_fine_ddc_select_e
 * @param  cddc             Coarse DDC pointer, @see adi_ad9082_adc_coarse_ddc_select_e
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_adc_ddc_coarse_sync_next_set(adi_ad9082_device_t *device, uint8_t cddcs, uint8_t enable);
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  i_mode         I test mode, @see adi_ad9082_test_mode_e
 * @param  q_mode         Q test mode, @see adi_ad9082_test_mode_e
 ...
 *         Call after adi_ad9082_device_startup_tx() and JESD TX is transmitting data.
 *
 * @param  device          Pointer to the device structure
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_rx_lanes_xbar_set(adi_ad9082_device_t *device, adi_ad9082_jesd_link_select_e links,
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_gpio_as_sync1_out_set(adi_ad9082_device_t *device, uint8_t mode);
 ...
 * @param  jesd_conv_sel Virtual converter selection, @see adi_ad9082_adc_fine_ddc_converter_e
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_tx_bring_up(adi_ad9082_device_t *device, adi_ad9082_jesd_link_select_e links,
    uint8_t lanes, adi_ad9082_jtx_conv_sel_t jesd_conv_sel[2]);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_tx_lanes_xbar_set(adi_ad9082_device_t *device, adi_ad9082_jesd_link_select_e links,
    uint8_t logical_lanes[8]);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_tx_ctrl_bit_sel_set(adi_ad9082_device_t *device, adi_ad9082_jesd_link_select_e links,
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_tx_format_sel_set(adi_ad9082_device_t *device, adi_ad9082_jesd_link_select_e links,
    uint8_t format);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_tx_fractional_delay_converter_selection_set(adi_ad9082_device_t *device, adi_ad9082_jesd_link_select_e links,
    uint16_t converters);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_tx_lids_cfg_set(adi_ad9082_device_t *device, adi_ad9082_jesd_link_select_e links,
    uint8_t lids[8]);
...
*/
int32_t adi_ad9082_device_get_temperature(adi_ad9082_device_t *device, int16_t *max, int16_t *min);
 ...
 *                       R0: PRBS7, PRBS15, PRBS31
 *                       R1: PRBS7, PRBS9, PRBS15, PRBS31
 * @param deser_mode     AD9082_HALF_RATE, AD9082_QUART_RATE
...
int32_t adi_ad9082_jesd_tx_repeat_user_data_test(adi_ad9082_device_t *device, adi_ad9082_jesd_link_select_e links,
    adi_ad9082_jesd_tx_test_data_src_e data_source, uint8_t data[9]);
 ...
 *
 * @param device         Pointer to the device reference handle.
 * @param links          Target link, @see adi_ad9082_jesd_link_select_e
 * @param prbs_pattern   PRBS pattern identifier, @see adi_cms_jesd_prbs_pattern_e
 *                       PRBS7, PRBS15, PRBS31
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_tx_sample_data_prbs_test(adi_ad9082_device_t *device, adi_ad9082_jesd_link_select_e links,
    adi_cms_jesd_prbs_pattern_e prbs_pattern);
 ...
 * @ingroup appdx_mcs
 * @brief  Block Top Level API. \n Start onshot sync
 *         Call after adi_ad9082_device_startup_rx() & adi_ad9082_device_startup_tx()
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_oneshot_sync(adi_ad9082_device_t *device, adi_cms_jesd_subclass_e subclass);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_sysref_phase_set(adi_ad9082_device_t *device, uint16_t phase);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_sysref_sample_type_set(adi_ad9082_device_t *device, uint8_t sample_type);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_reset_set(adi_ad9082_device_t *device);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_sync_reset_via_sysref_set(adi_ad9082_device_t *device, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_sync_sysref_mode_set(adi_ad9082_device_t *device, uint8_t mode);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_sync_set(adi_ad9082_device_t *device, uint8_t align_source);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_master_slave_mode_set(adi_ad9082_device_t *device, uint8_t mode);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_master_slave_gpio_set(adi_ad9082_device_t *device, uint8_t gpio_index, uint8_t output);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_master_slave_trigger_source_set(adi_ad9082_device_t *device, uint8_t source);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_master_slave_extra_lmfc_num_set(adi_ad9082_device_t *device, uint8_t num);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_master_slave_trigger_set(adi_ad9082_device_t *device);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_nco_master_slave_sync(adi_ad9082_device_t *device, uint8_t is_master, uint8_t trigger_src,
    uint8_t gpio_index, uint8_t extra_lmfc_num);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_enable_set(adi_ad9082_device_t *device, uint8_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_input_mode_set(adi_ad9082_device_t *device, uint8_t enable_receiver, uint8_t enable_capture, adi_cms_signal_coupling_e input_mode);
 ...
 * @return <0                                       Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_sync_sysref_input_config_set(adi_ad9082_device_t *device, adi_cms_signal_coupling_e coupling_mode, adi_cms_signal_type_e signal_type, uint8_t sysref_single_end_p, uint8_t sysref_single_end_n);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_setup_hold_get(adi_ad9082_device_t *device, uint8_t *setup_risk_assessment, uint8_t *hold_risk_assessment);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_fine_superfine_delay_set(adi_ad9082_device_t *device, uint8_t enable, uint8_t fine_delay, uint8_t superfine_delay);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_count_set(adi_ad9082_device_t *device, uint8_t edges);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_average_set(adi_ad9082_device_t *device, uint8_t pulses);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_monitor_phase_get (adi_ad9082_device_t *device, uint16_t *sysref_phase);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_monitor_lmfc_align_error_get(adi_ad9082_device_t *device, uint8_t *lmfc_align_err);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_monitor_lmfc_align_threshold_set(adi_ad9082_device_t *device, uint8_t sysref_error_window);
 ...
 * @return <0                    Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_irq_enable_set(adi_ad9082_device_t *device, uint8_t enable); 
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_irq_jitter_mux_set(adi_ad9082_device_t *device, uint8_t pin);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_jesd_sysref_oneshot_sync_done_get(adi_ad9082_device_t *device, uint8_t *sync_done);
 ...
 * @return <0                           Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_sync_calc_jrx_lmfc_lemc(uint64_t dac_clk, uint8_t main_interp, uint8_t ch_interp, adi_cms_jesd_param_t *jesd_param, uint64_t *lmfc_freq);
 ...
 * @return <0                           Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_sync_calc_jtx_lmfc_lemc(uint64_t adc_clk, uint8_t cddc_dcm[4], uint8_t fddc_dcm[8], adi_ad9082_jesd_link_select_e links, adi_cms_jesd_param_t jesd_param[2], uint64_t *lmfc_freq);
 ...
 * @return <0                           Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_sync_sysref_frequency_set(adi_ad9082_device_t *device, uint64_t *sysref_freq, uint64_t dev_ref, uint64_t dac_clk, uint64_t adc_clk, uint8_t main_interp, uint8_t ch_interp, uint8_t cddc_dcm[4], uint8_t fddc_dcm[8], adi_ad9082_jesd_link_select_e jtx_links, adi_cms_jesd_param_t *jrx_param, adi_cms_jesd_param_t jtx_param[2]);
 ...
 * @return <0                           Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_sync_jrx_tpl_phase_diff_get(adi_ad9082_device_t *device, adi_ad9082_jesd_link_select_e links, uint8_t *jrx_phase_diff);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_irqs_enable_set(adi_ad9082_device_t *device, uint64_t enable);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_irqs_status_get(adi_ad9082_device_t *device, uint64_t *status);
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_dac_irqs_status_clr(adi_ad9082_device_t *device, uint64_t clear);
...
/**
 * @ingroup appdx_loopback
 * @brief  Configure ad9082 direct loopback mode
 *         Note ADC sample rate must be same as DAC sample rate to get this loopback mode working.
 *         Should be called after adi_ad9082_device_init().
 *
 * @param  device  Pointer to the device structure
 ...
 * @return <0                                   Failed. @see adi_cms_error_e for details.
 */
int32_t adi_ad9082_device_direct_loopback_set(adi_ad9082_device_t *device, uint8_t mode, uint8_t mapping);
 ...
 *
 * @param  device         Pointer to the device structure
 * @param  adcs           @see adi_ad9082_adc_select_e
 ...
 *         Called by adi_ad9082_device_clk_config_set().
 *
 * @param  device  Pointer to the device structure
