...
from e7awghal.fwtype import E7FwType, E7FwAuxAttr
from e7awghal.quel1au50_hal import AbstractQuel1Au50Hal, _settings_awg_common, _settings_cap_standard, _settings_hbm_common, _settings_clock_standard, _settings_seq_simplemulti, _settings_au50rebooter
    ...
    for cls in (Quel1Au50SimplemultiStandardHalForTest, ):
        ...
        if cls.fw_type() == fw_type:
            ...
            proxy: AbstractQuel1Au50Hal = cls(
                name=name, ipaddrs={"A": ipaddr_wss, "B": ipaddr_sss}, mmcls=mmcls, auxattr=fw_auxattr, auth_callback=auth_callback,
            )
            break
    else:
