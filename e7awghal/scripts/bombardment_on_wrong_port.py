...
from e7awghal import AbstractQuel1Au50Hal, AwgCtrl, create_quel1au50hal
from e7awghal.e7awg_packet import E7awgOutgoingPacket
...
def send_cmd(ctrl) -> None:
    cmd = E7awgOutgoingPacket(
        mode=XE7awgPacketMode.BROKEN_CMD,  # type: ignore
        address=0,
        num_payload_bytes=0,
    )
    ctrl._udprw._sock.sendto(cmd._buffer, ctrl._udprw._dest_addrport)
