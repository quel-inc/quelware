...
def single_schedule():
    ...
    boxpool.emit_at(cp=cp, pgs={pg0}, min_time_offset=125_000_000, time_counts=(0,))
...
def multiple_schedule(num_iters: int = 3):
    ...
    boxpool.emit_at(
        cp=cp, pgs={pg0}, min_time_offset=125_000_000, time_counts=[i * 125_000_000 for i in range(num_iters)]
    )
...
if __name__ == "__main__":
    ...
    iq_list, chunks_list = multiple_schedule(5)
