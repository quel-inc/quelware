...
|                               #1                               | Read-out #0                                                 | 出力                                      | 観測信号出力用ポートです。0.5GHzから8.5GHzの範囲の連続する1.0GHz帯域の信号を2つ出力可能です。ただし、2つの出力帯域の中心周波数の差が3.75GHz以内でなければなりません。                     |
...
|                               #4                               | Ctrl #1                                                     | 出力                                      | 制御信号出力ポートです。0.5GHzから8.5GHzの範囲の連続する2.0GHz帯域の信号を2つ出力可能です。 ただし、2つの出力帯域の中心周波数の差が2.5GHz以内でなければなりません。                  　   |
...
|                               #8                               | Read-out #1                                                 | 出力                                      | 観測信号出力用ポートです。0.5GHzから8.5GHzの範囲の連続する1.0GHz帯域の信号を2つ出力可能です。ただし、2つの出力帯域の中心周波数の差が3.75GHz以内でなければなりません。                     |
...
|                              #11                               | Ctrl #3                                                     | 出力                                      | 制御信号出力ポートです。0.5GHzから8.5GHzの範囲の連続する2.0GHz帯域の信号を2つ出力可能です。ただし、2つの出力帯域の中心周波数の差が2.5GHz以内でなければなりません。                       |
...
|                              #16                               | Ctrl #6                                                     | 出力                                      | 制御信号出力ポートです。0.5GHzから8.5GHzの範囲の連続する2.0GHz帯域の信号を2つ出力可能です。ただし、2つの出力帯域の中心周波数の差が2.5GHz以内でなければなりません。                       |
|                              #17                               | Ctrl #7                                                     | 出力                                      | 制御信号出力ポートです。0.5GHzから8.5GHzの範囲の連続する2.0GHz帯域の信号を2つ出力可能です。ただし、2つの出力帯域の中心周波数の差が2.5GHz以内でなければなりません。                       |
...
ただし、2つの出力帯域の中心周波数の差は2.5GHz以下である必要があります。
...
ただし、2つの出力帯域の中心周波数の差は3.75GHz以下である必要があります。
