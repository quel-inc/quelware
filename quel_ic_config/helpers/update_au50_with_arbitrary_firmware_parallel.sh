...
quel_program_au50 --ipaddr 10.1.0.58 --macaddr 00-0a-35-0e-77-34 --firmware "${firmware_version}" --adapter 500202A506VAA --host "$HOST" --port "$PORT" 2>&1 | tee updatelog_058.log &
