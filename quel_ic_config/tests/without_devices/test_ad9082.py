...
assert param_rx.decimation_rate.main.as_cpptype() == [int(ad9081.ADC_CDDC_DCM_6) for _ in range(4)]
assert param_rx.c2r_enable.main == (0, 0, 0, 0)

assert param_rx.shift_freq.channel == (0, 0, 0, 0, 0, 0, 0, 0)
assert param_rx.decimation_rate.channel.as_cpptype() == [int(ad9081.ADC_FDDC_DCM_2) for _ in range(8)]
