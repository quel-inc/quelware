...
/*!
 * @addtogroup ADI_AD9082_INTERNAL_CONFIG
 * @{
 */
#ifndef __ADI_AD9082_CONFIG_H__
#define __ADI_AD9082_CONFIG_H__

/*============= D E F I N E S ==============*/

/*============= I N C L U D E S ============*/
#include "adi_ad9082.h"
#include "adi_ad9082_bf_impala_tc.h"
#include "adi_ad9082_bf_jrxa_des.h"
#include "adi_ad9082_bf_jtx_dual_link.h"
#include "adi_ad9082_bf_jtx_qbf_ad9082.h"
#include "adi_ad9082_bf_lcpll_28nm.h"
#include "adi_ad9082_bf_main.h"
#include "adi_ad9082_bf_nb_coarse_nco.h"
#include "adi_ad9082_bf_nb_ddc_dformat.h"
#include "adi_ad9082_bf_nb_fine_nco.h"
#include "adi_ad9082_bf_rx_paging.h"
#include "adi_ad9082_bf_ser_phy.h"
#include "adi_ad9082_bf_spi_only_up.h"
#include "adi_ad9082_bf_ad9082.h"
...
#define AD9082_API_REV  0x00010700
#define AD9082_API_HW_RESET_LOW  600000
#define AD9082_API_RESET_WAIT 500000
#define AD9082_PLL_LOCK_TRY  75
#define AD9082_PLL_LOCK_WAIT 20000
#define AD9082_JESD_CAL_BOOT_WAIT 250000
#define AD9082_JESD_MAN_CAL_WAIT 200000
#define AD9082_JESD_RX_204C_CAL_WAIT 500000
#define AD9082_JESD_FG_CAL_WAIT 200000
#define AD9082_JESD_BG_CAL_WAIT 10000
#define AD9082_SERDES_RST_WAIT 50000
#define AD9082_DESER_MODE_204B_BR_TRESH  8000000000ULL
#define AD9082_DESER_MODE_204C_BR_TRESH 16000000000ULL
#define AD9082_IL_CTLE_UPPER_DB_THRESH 10

/* var error report */
#define AD9082_MSG_REPORT(var, comment) \
    adi_ad9082_hal_error_report(device, ADI_CMS_LOG_MSG,  API_CMS_ERROR_OK, __FILE__, __FUNCTION_NAME__, __LINE__, #var, comment)
#define AD9082_WARN_REPORT(var, comment) \
    adi_ad9082_hal_error_report(device, ADI_CMS_LOG_WARN, API_CMS_ERROR_OK, __FILE__, __FUNCTION_NAME__, __LINE__, #var, comment)
#define AD9082_ERROR_REPORT(error, var, comment) \
    adi_ad9082_hal_error_report(device, ADI_CMS_LOG_ERR,  error, __FILE__, __FUNCTION_NAME__, __LINE__, #var, comment)

/* log report */
#define AD9082_LOG_FUNC() \
    adi_ad9082_hal_log_write(device, ADI_CMS_LOG_API, "%s(...)", __FUNCTION_NAME__)
#define AD9082_LOG_SPIR(addr, data) \
    adi_ad9082_hal_log_write(device, ADI_CMS_LOG_SPI, "ad9082: r@%.4x = %.2x", addr, data)
#define AD9082_LOG_SPIW(addr, data) \
    adi_ad9082_hal_log_write(device, ADI_CMS_LOG_SPI, "ad9082: w@%.4x = %.2x", addr, data)
#define AD9082_LOG_SPIR32(addr, data) \
    adi_ad9082_hal_log_write(device, ADI_CMS_LOG_SPI, "ad9082: r32@%.4x = %.8x", addr, data)
#define AD9082_LOG_SPIW32(addr, data) \
    adi_ad9082_hal_log_write(device, ADI_CMS_LOG_SPI, "ad9082: w32@%.4x = %.8x", addr, data)
#define AD9082_LOG_VAR(type, msg, ...) \
    adi_ad9082_hal_log_write(device, type, msg, ##__VA_ARGS__)
#define AD9082_LOG_MSG(msg) \
    adi_ad9082_hal_log_write(device, ADI_CMS_LOG_MSG, msg)
#define AD9082_LOG_WARN(msg) \
    adi_ad9082_hal_log_write(device, ADI_CMS_LOG_WARN, msg)
#define AD9082_LOG_ERR(msg) \
    adi_ad9082_hal_log_write(device, ADI_CMS_LOG_ERR, msg)

/* var error check */
#define AD9082_ERROR_RETURN(r) \
{ \
    if (r != API_CMS_ERROR_OK) { \
        return r; \
    } \
}
#define AD9082_NULL_POINTER_RETURN(p) \
{ \
    if(p == NULL) { \
        AD9082_ERROR_REPORT(API_CMS_ERROR_NULL_PARAM, p, "Null pointer passed."); \
        return API_CMS_ERROR_NULL_PARAM; \
    } \
}
#define AD9082_INVALID_PARAM_RETURN(r) \
{ \
    if(r) { \
        AD9082_ERROR_REPORT(API_CMS_ERROR_INVALID_PARAM, r, "Invalid param passed."); \
        return API_CMS_ERROR_INVALID_PARAM; \
    } \
}
#define AD9082_INVALID_PARAM_WARN(r) \
{ \
    if(r) { \
        AD9082_WARN_REPORT(r, "Invalid param passed."); \
    } \
}
 ...
 * 
 *      Note: ACC_DELTA and ACC_MODULUS are set via adi_ad9082_dac_duc_nco_ftw_set call.
 * 
 * 
 * \param[in]  device	         Pointer to device handler structure.
 ...
 * \param[in]  dacs         DAC mask, like AD9082_DAC_0, ...
 * \param[in]  channels     Channel mask, like AD9082_DAC_CH_0, ...
 ...
 * 
 *  Essentially a wrapper for adi_ad9082_adc_core_setup.
 *
 * 
 * \param[in]  device	         Pointer to device handler structure.
 ...
 *
 * \param[in]  device        Pointer to the device structure
 * \param[in]  cddcs         Coarse DDCs selection, @see adi_ad9082_adc_coarse_ddc_select_e
 ...
 *
 * \param[in]  device        Pointer to the device structure
 * \param[in]  fddcs         Fine DDCs selection, @see adi_ad9082_adc_fine_ddc_select_e
 ...
 *
 * \param[in]  device	         Pointer to device handler structure.
 * \param[in]  links             Choose AD9082 link(s) to set mask for:
 *                                  0x1 - AD9082_LINK_0
 *                                  0x2 - AD9082_LINK_1 
 *                                  0x3 - Both
 ...
 *                                  0x2 - AD9082_LINK_1 
 *                                  0x3 - Both
 * \param[in]  jesd_conv_sel     jesd_conv_sel[0] - Virtual converter selection struct for AD9082_LINK_0. 
 *                               jesd_conv_sel[1] - Virtual converter selection struct for AD9082_LINK_1.
 * \param[in]  jesd_m            jesd_m[0] - Number of used virtual converters for AD9082_LINK_0.
...
/**
 * \brief Finds the highest common unused DFormat output between both AD9082 links.
 *
 * \param[in]  links             0x1 - Outputs first unused DFormat output for AD9082_LINK_0.
 *                               0x2 - Outputs first unused DFormat output for AD9082_LINK_1. 
 ...
 */
int32_t adi_ad9082_jesd_sysref_d2acenter_enable_set(adi_ad9082_device_t *device, uint8_t enable);
 ...
 * \return API_CMS_ERROR_OK is returned upon success. Otherwise, a failure code. 
 */
int32_t adi_ad9082_sync_sysref_ctrl(adi_ad9082_device_t *device);
 ...
 *                                  0x2 - AD9082_LINK_1 
 *                                  0x3 - Both
 * \param[in]   jtx_lane_rate    jtx_lane_rate[0] - lane rate in bps for AD9082_LINK_0.
 *                               jtx_lane_rate[1] - lane rate in bps for AD9082_LINK_1.
 * \param[out]  jtx_brr          jtx_brr[0] - JTX_BR_LOG2_RATIO value for AD9082_LINK_0.
 *                               jtx_brr[1] - JTX_BR_LOG2_RATIO value for AD9082_LINK_1.
 * 
 * \returns API_CMS_ERROR_OK is returned upon success. Otherwise, a failure code.
 */
...
#if AD9082_USE_FLOATING_TYPE > 0
int32_t adi_ad9082_hal_calc_nco_ftw_f(adi_ad9082_device_t* device, double freq, double nco_shift, uint64_t *ftw, uint64_t *a, uint64_t *b);
#endif
