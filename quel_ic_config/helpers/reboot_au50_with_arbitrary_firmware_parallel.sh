...
quel_program_au50 --ipaddr 10.1.0.50 --macaddr 00-0a-35-0e-74-10 --firmware "${firmware_version}" --adapter 500202A50TTAA --host "$HOST" --port "$PORT" --bit 2>&1 | tee updatelog_050.log &
