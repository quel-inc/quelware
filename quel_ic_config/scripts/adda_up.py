...
from quel_ic_config import Quel1BoxType, Quel1ConfigOption, Quel1SeProtoAddaConfigSubsystem
...
if __name__ == "__main__":
    ...
    # Config !
    #
    css = Quel1SeProtoAddaConfigSubsystem(css_addr, Quel1BoxType.fromstr("x-quel1se-adda"), None, config_options)
